...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(com.john.Usuario.infrastructure.security.JwtUtil jwtUtil, UserDetailsService userDetailsService) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        com.john.Usuario.infrastructure.security.JwtRequestFilter jwtRequestFilter = new com.john.Usuario.infrastructure.security.JwtRequestFilter(jwtUtil, userDetailsService);
